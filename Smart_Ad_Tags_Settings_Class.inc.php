...
class Smart_Ad_Tags_Settings {
    ...
    function register_in_post_ad_settings() {
     $this->plugin_settings_tabs[$this->in_post_ad_settings_key] = 'Content';
    }
            ...
            <form method="post" action="">
             ...
             <table class="form-table">
              ...
              <tr valign="top">
               ...
               <td><input type="text" name="group" maxlength="7" value=""/></td>
              </tr>
         ...
         <?php
          ...
          <div class="main_smart">
           <div class="left_smart">
            ...
            <h2><?php _e('Create or Update Unit','banner-ads') ?></h2>
            ...
            <form method="post" action="">
             ...
             <table class="form-table">
              ...
              <tr valign="top">
               <th scope="row"><?php _e('Unit Name : ','banner-ads') ?></th>
               <td><input type="text" name="adgroup" maxlength="7" value=""/></td>
              </tr>
            ...
            <h2><?php _e('Delete Unit','banner-ads') ?></h2>
            ...
            <form method="post" action="">
             ...
             <table class="form-table">
              ...
              <tr valign="top">
               <th scope="row"><?php _e('Select Unit : ','banner-ads') ?></th>
             ...
             <p class="submit">
              <input type="submit" class="button-primary" value="<?php _e('Delete Unit','banner-ads') ?>" />
             </p>
            </form>
           </div>
           ...
           <div class="right_smart">
             ...
             <table class="form-table">
              <tr valign="top">
               ...
               <tr valign="top">
              	<th scope="row"><?php _e('Tutorial : ','banner-ads') ?></th>
              
              	<td>
              	    <a href="http://wordpresswebhostingnsolution.com/2016/03/01/wordpress-advertising-plugin-smart-ad-tags-reviews/" rel="nofollow" target="_blank">How to use this plugin</a>
              		
              	</td>
              	
              </tr>
              <tr valign="top">
              	<th scope="row"><?php _e('Recommend Plugin : ','banner-ads') ?></th>
              
              	<td>
              		<a href="https://wordpress.org/plugins/clean-it-up/" rel="nofollow" target="_blank">Clean Up Database</a>
              	</td>
              	
              </tr>
             <tr valign="top">
              	<th scope="row"><?php _e('Recommend Software : ','banner-ads') ?></th>
              
              	<td><a href="http://wordpresswebhostingnsolution.com/2016/03/16/niche-keyword-research-software/" rel="nofollow" target="_blank">Niche keyword research software</a>
              	</td>
              	
              </tr>
              <tr valign="top">
              	<th scope="row"><?php _e('Free Web Template : ','banner-ads') ?></th>
              
              	<td>
              	    <a href="http://wordpresswebhostingnsolution.com/2016/03/16/free-web-template-for-shopping-website/" rel="nofollow" target="_blank">Business Web Template</a>
